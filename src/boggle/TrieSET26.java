...
public class TrieSET26 implements Iterable<String> {
    ...
    private Node get(Node x, String key, int d) {
        ...
        char c = key.charAt(d);
        return get(x.next[Alphabet.UPPERCASE.toIndex(c)], key, d + 1);
    }
    ...
    private Node add(Node x, String key, int d) {
        ...
        if (d == key.length()) {
            ...
            char c = key.charAt(d);
            x.next[Alphabet.UPPERCASE.toIndex(c)] = add(x.next[Alphabet.UPPERCASE.toIndex(c)], key,
                                                        d + 1);
        }
        return x;
    }
    ...
    /**
     * Search if the trie contains a prefix
     *
    ...
    //     return get(x.next[Alphabet.UPPERCASE.toIndex(c)], prefix, d + 1);
    // }
    ...
    private void collect(Node x, StringBuilder prefix, Queue<String> results) {
        ...
        for (int i = 0; i < R; i++) {
            char c = Alphabet.UPPERCASE.toChar(i);
            prefix.append(c);
            collect(x.next[Alphabet.UPPERCASE.toIndex(c)], prefix, results);
            prefix.deleteCharAt(prefix.length() - 1);
        }
    }

    /* BE CAREFUL WHEN USING THE METHODS BELOW: METHODS HAVE NOT BEEN ADAPTED TO 26-WAY TRIE!
    // ====================================================================================
    //  */
    //
    // /**
